...
import { ParametroCreacionDto, ParametroDto, ParametroModificacionDto } from '../../../transferencia';
import { ParametroFiltroDto } from '../../../transferencia/filtros';
export declare const PARAMETRO_SERVICIO = "PARAMETRO_SERVICIO";
export interface IParametroServicio {
    buscar(filtro: Partial<ParametroFiltroDto>, pagina: number, cantidad: number, ordenarPor?: string, orden?: 'ASC' | 'DESC'): Promise<ListaPaginadaDto<ParametroDto>>;
