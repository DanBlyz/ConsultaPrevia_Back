...
import { AutenticacionDto, CuentaCreacionDto, CuentaDto, CuentaModificacionDto, UsuarioCreacionDto, UsuarioDto } from '../../../transferencia';
...
export interface ICuentaServicio {
    ...
    guardar(objetoDto: CuentaCreacionDto, usuario?: UsuarioCreacionDto): Promise<RespuestaObjetoDto<CuentaDto>>;
