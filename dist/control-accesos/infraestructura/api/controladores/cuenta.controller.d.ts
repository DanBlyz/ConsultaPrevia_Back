...
import { CuentaDto, RolCuentaCreacionDto, RolCuentaDto, RolCuentaModificacionDto } from '../../../dominio/transferencia';
export declare class CuentaController {
    ...
    guardar(objetoDto: any): Promise<RespuestaObjetoDto<CuentaDto>>;
