...
__decorate([
    (0, classes_1.AutoMap)(),
    (0, typeorm_1.Column)({ name: 'codigounico' }),
    __metadata("design:type", Number)
], TramiteEntity.prototype, "codigoUnico", void 0);
__decorate([
    (0, classes_1.AutoMap)(),
    (0, typeorm_1.Column)({ name: 'areaminera' }),
    __metadata("design:type", String)
], TramiteEntity.prototype, "areaMinera", void 0);
__decorate([
    (0, classes_1.AutoMap)(),
    (0, typeorm_1.Column)({ name: 'clasificacion' }),
    __metadata("design:type", String)
...
__decorate([
    (0, classes_1.AutoMap)(),
    (0, typeorm_1.Column)({ name: 'provincia' }),
    __metadata("design:type", String)
], TramiteEntity.prototype, "provincia", void 0);
__decorate([
    (0, classes_1.AutoMap)(),
    (0, typeorm_1.Column)({ name: 'municipio' }),
    __metadata("design:type", String)
