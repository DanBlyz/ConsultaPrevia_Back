...
let RolController = class RolController {
    ...
    async buscar(filtroDto) {
        ...
        const registrosPorPagina = filtroDto.paginado
            ...
            : 10;
        const { lista, totalRegistros } = await this.servicioFactory.rolServicio.buscar(filtroDto, pagina, registrosPorPagina);
...
__decorate([
    ...
    __metadata("design:paramtypes", [filtros_1.RolFiltroDto]),
    __metadata("design:returntype", Promise)
], RolController.prototype, "buscar", null);
__decorate([
    (0, common_1.Get)(':id'),
