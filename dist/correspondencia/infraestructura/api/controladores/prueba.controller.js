...
let PruebaController = class PruebaController {
    ...
    async buscar(filtroDto) {
        ...
        const registrosPorPagina = filtroDto.paginado
            ...
            : 10;
        const { lista, totalRegistros } = await this.servicioFactory.pruebaServicio.buscar(filtroDto, pagina, registrosPorPagina);
    ...
    async obtenerPorId(id) {
        const objetoDto = await this.servicioFactory.pruebaServicio.obtenerPorId(id);
        return new transferencia_1.RespuestaObjetoDto(transferencia_1.TipoRespuesta.Exito, '', objetoDto);
    }
    async guardar(objetoDto) {
        return await this.servicioFactory.pruebaServicio.guardar(objetoDto);
    }
    async modificar(id, objetoDto) {
        return await this.servicioFactory.pruebaServicio.modificar(id, objetoDto);
    }
    async eliminar(id) {
        return await this.servicioFactory.pruebaServicio.eliminar(id);
    }
};
__decorate([
    ...
    __metadata("design:paramtypes", [filtros_1.PruebaFiltroDto]),
    __metadata("design:returntype", Promise)
], PruebaController.prototype, "buscar", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], PruebaController.prototype, "obtenerPorId", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transferencia_2.PruebaCreacionDto]),
    __metadata("design:returntype", Promise)
], PruebaController.prototype, "guardar", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, transferencia_2.PruebaModificacionDto]),
    __metadata("design:returntype", Promise)
], PruebaController.prototype, "modificar", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], PruebaController.prototype, "eliminar", null);
