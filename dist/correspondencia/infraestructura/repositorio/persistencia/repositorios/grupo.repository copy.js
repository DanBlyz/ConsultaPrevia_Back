...
const __1 = require("../..");
let GrupoRepository = GrupoRepository_1 = class GrupoRepository {
    ...
    async obtenerObjetoPor(filtro, ordenarPor = 'id', orden = 'DESC') {
        ...
        let consulta = this.repositorio.createQueryBuilder('grupo');
    ...
    async eliminar(id, transaccion, borradoFisico = false) {
        if (borradoFisico) {
            ...
            const objetoEntity = await transaccion.manager.preload(orm_1.GrupoEntity, {
                id,
            });
...
GrupoRepository = GrupoRepository_1 = __decorate([
...
//# sourceMappingURL=grupo.repository%20copy.js.map