...
import { PuestoPersonaCreacionDto, PuestoPersonaDto, PuestoPersonaModificacionDto } from '../../../transferencia';
import { PuestoPersonaFiltroDto } from '../../../transferencia/filtros';
export declare const PUESTO_PERSONA_SERVICIO = "PUESTO_PERSONA_SERVICIO";
export interface IPuestoPersonaServicio {
    buscar(filtro: Partial<PuestoPersonaFiltroDto>, pagina: number, cantidad: number, ordenarPor?: string, orden?: 'ASC' | 'DESC'): Promise<ListaPaginadaDto<PuestoPersonaDto>>;
    ...
    modificarInterinato(id: number, objetoDto: Partial<PuestoPersonaModificacionDto>): Promise<RespuestaObjetoDto<PuestoPersonaDto>>;
