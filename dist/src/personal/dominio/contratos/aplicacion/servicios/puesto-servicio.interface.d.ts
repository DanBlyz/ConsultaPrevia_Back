...
import { PuestoCreacionDto, PuestoDto, PuestoModificacionDto } from '../../../transferencia';
...
export interface IPuestoServicio {
    buscar(filtro: Partial<PuestoFiltroDto>, pagina: number, cantidad: number, ordenarPor?: string, orden?: 'ASC' | 'DESC'): Promise<ListaPaginadaDto<PuestoDto>>;
