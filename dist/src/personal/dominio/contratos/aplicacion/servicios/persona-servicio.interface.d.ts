...
import { PersonaCreacionDto, PersonaDto, PersonaModificacionDto } from '../../../transferencia';
...
export interface IPersonaServicio {
    buscar(filtro: Partial<PersonaFiltroDto>, pagina: number, cantidad: number, ordenarPor?: string, orden?: 'ASC' | 'DESC'): Promise<ListaPaginadaDto<PersonaDto>>;
