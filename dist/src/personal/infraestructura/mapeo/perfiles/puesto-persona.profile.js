...
let PuestoPersonaProfile = exports.PuestoPersonaProfile = class PuestoPersonaProfile extends nestjs_1.AutomapperProfile {
    constructor(mapper) {
        super(mapper);
    }
    get profile() {
...
exports.PuestoPersonaProfile = PuestoPersonaProfile = __decorate([
