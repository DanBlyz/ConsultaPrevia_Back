...
const _1 = require(".");
let CuentaEntity = exports.CuentaEntity = class CuentaEntity extends auditoria_entity_1.AuditoriaEntity {
};
__decorate([
    (0, classes_1.AutoMap)(),
...
__decorate([
    (0, classes_1.AutoMap)(),
    (0, typeorm_1.Column)({ name: 'CLAVE' }),
    __metadata("design:type", String)
], CuentaEntity.prototype, "clave", void 0);
__decorate([
    (0, classes_1.AutoMap)(),
...
exports.CuentaEntity = CuentaEntity = __decorate([
