...
let GrupoProfile = exports.GrupoProfile = class GrupoProfile extends nestjs_1.AutomapperProfile {
    constructor(mapper) {
        super(mapper);
    }
    get profile() {
        return (mapper) => {
            ...
            (0, core_1.createMap)(mapper, orm_1.GrupoEntity, entidades_1.Grupo, (0, core_1.forMember)((destino) => destino.sePuedeModificar, (0, core_1.fromValue)(true)), (0, core_1.forMember)((destino) => destino.sePuedeEliminar, (0, core_1.mapFrom)((origen) => origen.listaRol && origen.listaRol.length > 0 ? false : true)));
        };
    }
};
exports.GrupoProfile = GrupoProfile = __decorate([
