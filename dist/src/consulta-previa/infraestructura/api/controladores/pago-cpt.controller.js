...
exports.PagoCptController = void 0;
...
let PagoCptController = exports.PagoCptController = class PagoCptController {
    ...
    async buscar(filtroDto) {
        ...
        const registrosPorPagina = filtroDto.paginado
            ...
            : 10;
        const { lista, totalRegistros } = await this.servicioFactory.pagoCptServicio.buscar(filtroDto, pagina, registrosPorPagina);
    ...
    async obtenerPorId(id) {
        const objetoDto = await this.servicioFactory.pagoCptServicio.obtenerPorId(id);
    ...
    async modificar(id, objetoDto) {
        return await this.servicioFactory.pagoCptServicio.modificar(id, objetoDto);
    }
    async eliminar(id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [filtros_1.PagoCptFiltroDto]),
    __metadata("design:returntype", Promise)
], PagoCptController.prototype, "buscar", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], PagoCptController.prototype, "obtenerPorId", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transferencia_2.PagoCptCreacionDto]),
    __metadata("design:returntype", Promise)
], PagoCptController.prototype, "guardar", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, transferencia_2.PagoCptModificacionDto]),
    __metadata("design:returntype", Promise)
], PagoCptController.prototype, "modificar", null);
__decorate([
