...
let DocumentoController = class DocumentoController {
    ...
    async downloadFile(filename, res) {
        const path = (0, path_1.join)('..', 'ConsultaPrevia_Back/consulta-previa/documento', filename);
...
__decorate([
    ...
    (0, common_2.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        storage: (0, multer_1.diskStorage)({
            destination: './consulta-previa/documento',
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DocumentoController.prototype, "downloadFile", null);
