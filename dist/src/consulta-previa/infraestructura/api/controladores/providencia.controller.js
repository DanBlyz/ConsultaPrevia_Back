...
exports.ProvidenciaController = void 0;
...
let ProvidenciaController = exports.ProvidenciaController = class ProvidenciaController {
    ...
    async buscar(filtroDto) {
        ...
        const registrosPorPagina = filtroDto.paginado
            ...
            : 10;
        const { lista, totalRegistros } = await this.servicioFactory.providenciaServicio.buscar(filtroDto, pagina, registrosPorPagina);
    ...
    async obtenerPorId(id) {
        const objetoDto = await this.servicioFactory.providenciaServicio.obtenerPorId(id);
    ...
    async modificar(id, objetoDto) {
        return await this.servicioFactory.providenciaServicio.modificar(id, objetoDto);
    }
    async eliminar(id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [filtros_1.ProvidenciaFiltroDto]),
    __metadata("design:returntype", Promise)
], ProvidenciaController.prototype, "buscar", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], ProvidenciaController.prototype, "obtenerPorId", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transferencia_2.ProvidenciaCreacionDto]),
    __metadata("design:returntype", Promise)
], ProvidenciaController.prototype, "guardar", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, transferencia_2.ProvidenciaModificacionDto]),
    __metadata("design:returntype", Promise)
], ProvidenciaController.prototype, "modificar", null);
__decorate([
