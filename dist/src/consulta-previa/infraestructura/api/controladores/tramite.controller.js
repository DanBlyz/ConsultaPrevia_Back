...
let TramiteController = exports.TramiteController = class TramiteController {
    ...
    async buscar(filtroDto) {
        ...
        const registrosPorPagina = filtroDto.paginado
            ...
            : 10;
        const { lista, totalRegistros } = await this.servicioFactory.tramiteServicio.buscar(filtroDto, pagina, registrosPorPagina);
    ...
    async obtenerPorId(id) {
        const objetoDto = await this.servicioFactory.tramiteServicio.obtenerPorId(id);
    ...
    async modificar(id, objetoDto) {
        return await this.servicioFactory.tramiteServicio.modificar(id, objetoDto);
    }
    async eliminar(id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [filtros_1.TramiteFiltroDto]),
    __metadata("design:returntype", Promise)
], TramiteController.prototype, "buscar", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], TramiteController.prototype, "obtenerPorId", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transferencia_2.TramiteCreacionDto]),
    __metadata("design:returntype", Promise)
], TramiteController.prototype, "guardar", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    ...
    __metadata("design:returntype", Promise)
], TramiteController.prototype, "modificar", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], TramiteController.prototype, "eliminar", null);
exports.TramiteController = TramiteController = __decorate([
