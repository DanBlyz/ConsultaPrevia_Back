...
let ViajeController = exports.ViajeController = class ViajeController {
    ...
    async buscar(filtroDto) {
        ...
        const registrosPorPagina = filtroDto.paginado
            ...
            : 10;
        const { lista, totalRegistros } = await this.servicioFactory.viajeServicio.buscar(filtroDto, pagina, registrosPorPagina);
    ...
    async obtenerPorId(id) {
        const objetoDto = await this.servicioFactory.viajeServicio.obtenerPorId(id);
    ...
    async modificar(id, objetoDto) {
        return await this.servicioFactory.viajeServicio.modificar(id, objetoDto);
    }
    async eliminar(id) {
    ...
    async downloadFile(filename, res) {
        const path = (0, path_1.join)('..', 'ConsultaPrevia_Back/consulta-previa/viaje', filename);
...
__decorate([
    ...
    __metadata("design:paramtypes", [filtros_1.ViajeFiltroDto]),
    __metadata("design:returntype", Promise)
], ViajeController.prototype, "buscar", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], ViajeController.prototype, "obtenerPorId", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transferencia_2.ViajeCreacionDto]),
    __metadata("design:returntype", Promise)
], ViajeController.prototype, "guardar", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, transferencia_2.ViajeModificacionDto]),
    __metadata("design:returntype", Promise)
], ViajeController.prototype, "modificar", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ViajeController.prototype, "uploadFile", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ViajeController.prototype, "downloadFile", null);
