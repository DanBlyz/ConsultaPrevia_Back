...
export const USUARIO_SERVICIO = 'USUARIO_SERVICIO';
...
export interface IUsuarioServicio {
  buscar(
    ...
    pagina: number,
    cantidad: number,
  ): Promise<ListaPaginadaDto<UsuarioDto>>;
  ...
  modificarPorCodCuenta(codCuenta: string, objetoDto: UsuarioModificacionDto);
}
